...
export default function QuotePopup() {
  ...
  return (
    <div className="fixed top-8 left-1/2 -translate-x-1/2 z-[1] w-[75vw] max-w-5xl pointer-events-none px-4 animate-in slide-in-from-top-10 fade-in duration-500 flex justify-center">
      <DraggableWidget id="quote">
        <div className="relative p-6 text-white overflow-hidden group text-center drop-shadow-2xl bg-black/20 backdrop-blur-sm border border-white/10 rounded-3xl w-max max-w-full">
          <div
